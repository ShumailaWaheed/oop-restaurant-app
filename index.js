...
class MenuItem {
    ...
    category;
    availability;
    constructor(name, description, price, category, availability = true) {
        this.name = name;
...
class Order {
    ...
    constructor(id, items, customer, status = "pending", paymentDetails // Optional payment details
    ) {
        this.id = id;
        this.items = items;
    ...
    static create(customer, items, paymentDetails) {
...
class Restaurant {
    ...
    menu;
    orders;
    constructor(name, location, menu = [], orders = []) {
        this.name = name;
    ...
    // Create a new order
    createOrder(customer, items, paymentDetails) {
